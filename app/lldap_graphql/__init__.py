...
class lldap_graphql:
    ...
    def get_token(self) -> None:
        ...
        response: requests.Response = requests.post(self.auth_url, json=payload, timeout=10)
    ...
    def get_new_token(self, refresh_token: str | None = None) -> None:
        ...
        response: requests.Response = requests.get(self.refresh_url, cookies=cookies, timeout=10)
        response.raise_for_status()
        data: dict[str, Any] = response.json()
    ...
    def run_query(self, query: str, variables: dict) -> dict[str, Any]:
        ...
        def do_request() -> requests.Response:
            return requests.post(self.graphql_url, headers=headers, json=payload, timeout=10)
